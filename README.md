...
2. **Beat 2: Vulnerability Contrast**: Side-by-side comparison (Ward 8 sparse vs Ward 2 Medical Hub).
...
5. **Beat 5: Hazard-Aware Routing**: Route map display, "Trigger Road Block" toggle, live reroute + Accessibility flag change.
